 ...
 *
 */
public class TestOrientation extends Test
{

    private boolean non_viable = false;
    private Random randomgenerator;
    
    public TestOrientation(Deplacement deplacement, int nbIteration,
    ...
    public void proceedTest()
    {
        ...
        * 0: POUSSE
        * 1: DEBOUT
        * 2: AVANT en GAUCHE_HAUT
        * 3: AVANT en HAUT
        * 4: AVANT en DROITE_HAUT
        */
        String etat_test;
        ...
        for(int i = 0; i < 6; i++)
            if(randomgenerator.nextBoolean()) // la patte bouge
            {
                ...
                else if(etat_suivant.charAt(i) == '1')
                {
                    ...
                    etat_suivant = etat_suivant.substring(0,i) + (randomgenerator.nextInt(3)+2) + etat_suivant.substring(i+1);
                }
    ...
    public void init()
    {
        ...
        deplacement.setMode(Mode.TRIPHASE_ORIENTATION);
